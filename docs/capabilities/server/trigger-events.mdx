...
| ------------------------------ | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------- |
| `onPostSubmit`                 | A newly submitted post                              | [`OnPostSubmitRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                                 | Does not wait for media checks       | [View](#onpostsubmit)                 |
| `onPostCreate`                 | A newly created post after additional processing    | [`OnPostCreateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                                 | Allows time for media checks         | [View](#onpostcreate)                 |
| `onPostUpdate`                 | An edit to a post's body                            | [`OnPostUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                                 | Allows applicable media checks       | [View](#onpostupdate)                 |
| `onPostReport`                 | A report on a post                                  | [`OnPostReportRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                                 | State-change event                   | [View](#onpostreport)                 |
| `onPostDelete`                 | A post deletion or removal                          | [`OnPostDeleteRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                                 | State-change event                   | [View](#onpostdelete)                 |
| `onPostFlairUpdate`            | A post flair change                                 | [`OnPostFlairUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                       | State-change event                   | [View](#onpostflairupdate)            |
| `onPostNsfwUpdate`             | A post's NSFW status changing                       | [`OnPostNsfwUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                         | State-change event                   | [View](#onpostnsfwupdate)             |
| `onPostSpoilerUpdate`          | A post's spoiler status changing                    | [`OnPostSpoilerUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                   | State-change event                   | [View](#onpostspoilerupdate)          |
| `onCommentSubmit`              | A newly submitted comment                           | [`OnCommentSubmitRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                           | Does not wait for media checks       | [View](#oncommentsubmit)              |
| `onCommentCreate`              | A newly created comment after additional processing | [`OnCommentCreateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                           | Allows time for media checks         | [View](#oncommentcreate)              |
| `onCommentUpdate`              | An edit to a comment's body                         | [`OnCommentUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                           | Allows applicable media checks       | [View](#oncommentupdate)              |
| `onCommentReport`              | A report on a comment                               | [`OnCommentReportRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                           | State-change event                   | [View](#oncommentreport)              |
| `onCommentDelete`              | A comment deletion or removal                       | [`OnCommentDeleteRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                           | State-change event                   | [View](#oncommentdelete)              |
| `onModAction`                  | An entry in a community's moderation log            | [`OnModActionRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/reddit/v2alpha/modaction.d.ts)                                                     | Moderation event                     | [View](#onmodaction)                  |
| `onModMail`                    | A new modmail message                               | [`OnModMailRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/reddit/v2alpha/modmail.d.ts)                                                         | Messaging event                      | [View](#onmodmail)                    |
| `onAutomoderatorFilterPost`    | AutoModerator filtering a post                      | [`OnAutomoderatorFilterPostRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)       | Filtered-content event               | [View](#onautomoderatorfilterpost)    |
| `onAutomoderatorFilterComment` | AutoModerator filtering a comment                   | [`OnAutomoderatorFilterCommentRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts) | Filtered-content event               | [View](#onautomoderatorfiltercomment) |
| `onAppInstall`                 | An app installation in a subreddit                  | [`OnAppInstallRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                                 | Lifecycle event                      | [View](#onappinstall)                 |
| `onAppUpgrade`                 | An installation moving to a different app version   | [`OnAppUpgradeRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)                                 | Lifecycle event                      | [View](#onappupgrade)                 |
| `onMentionInCommentCreate`     | A new comment that mentions the app username        | [`OnMentionInCommentCreateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)         | Global; allows time for media checks | [View](#onmentionincommentcreate)     |
...
**Payload:** [`OnPostSubmitRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnPostCreateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnPostUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnPostReportRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnPostDeleteRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnPostFlairUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnPostNsfwUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnPostSpoilerUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnCommentSubmitRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnCommentCreateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnCommentUpdateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnCommentReportRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnCommentDeleteRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnModActionRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/reddit/v2alpha/modaction.d.ts)
...
**Payload:** [`OnModMailRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/reddit/v2alpha/modmail.d.ts)
...
**Payload:** [`OnAutomoderatorFilterPostRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnAutomoderatorFilterCommentRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnAppInstallRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnAppUpgradeRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
...
**Payload:** [`OnMentionInCommentCreateRequest`](https://unpkg.com/browse/@devvit/protos@0.14.0/json/devvit/events/v1alpha/events.d.ts)
