...
| ------------------------------ | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------- |
| `onPostSubmit`                 | A newly submitted post                              | [`OnPostSubmitRequest`](#onpostsubmit-payload)                                 | Does not wait for media checks       | [View](#onpostsubmit)                 |
| `onPostCreate`                 | A newly created post after additional processing    | [`OnPostCreateRequest`](#onpostcreate-payload)                                 | Allows time for media checks         | [View](#onpostcreate)                 |
| `onPostUpdate`                 | An edit to a post's body                            | [`OnPostUpdateRequest`](#onpostupdate-payload)                                 | Allows applicable media checks       | [View](#onpostupdate)                 |
...
| `onCommentSubmit`              | A newly submitted comment                           | [`OnCommentSubmitRequest`](#oncommentsubmit-payload)                           | Does not wait for media checks       | [View](#oncommentsubmit)              |
| `onCommentCreate`              | A newly created comment after additional processing | [`OnCommentCreateRequest`](#oncommentcreate-payload)                           | Allows time for media checks         | [View](#oncommentcreate)              |
| `onCommentUpdate`              | An edit to a comment's body                         | [`OnCommentUpdateRequest`](#oncommentupdate-payload)                           | Allows applicable media checks       | [View](#oncommentupdate)              |
...
| `onMentionInCommentCreate`     | A new comment that mentions the app username        | [`OnMentionInCommentCreateRequest`](#onmentionincommentcreate-payload)         | Global; allows time for media checks | [View](#onmentionincommentcreate)     |
